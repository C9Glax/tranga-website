...
> extends HttpClient<SecurityDataType> {
  ...
  fileLibraryDetail = (fileLibraryId: string, params: RequestParams = {}) =>
    this.request<FileLibrary, ProblemDetails>({
  ...
  libraryConnectorDetail = (
    ...
    this.request<LibraryConnector, ProblemDetails>({
  ...
  mangaDetail = (mangaId: string, params: RequestParams = {}) =>
    this.request<Manga, ProblemDetails>({
   ...
   * @summary Merge two API.Schema.MangaContext.Manga into one. THIS IS NOT REVERSIBLE!
   ...
   * @tags Manga
   * @name MangaCoverList
   * @summary Returns Cover of API.Schema.MangaContext.Manga with MangaId
  ...
  mangaCoverList = (
    ...
    this.request<string, ProblemDetails | number>({
   ...
   * @summary Returns all downloaded API.Schema.MangaContext.Chapter for API.Schema.MangaContext.Manga with MangaId
   ...
   * @summary Returns all API.Schema.MangaContext.Chapter not downloaded for API.Schema.MangaContext.Manga with MangaId
   ...
   * @summary Returns the latest API.Schema.MangaContext.Chapter of requested API.Schema.MangaContext.Manga available on API.MangaConnectors.MangaConnector
  ...
  mangaChapterLatestAvailableList = (
    ...
    this.request<Chapter, string | void | number>({
   ...
   * @summary Returns the latest API.Schema.MangaContext.Chapter of requested API.Schema.MangaContext.Manga that is downloaded
  ...
  mangaChapterLatestDownloadedList = (
    ...
    this.request<Chapter, ProblemDetails | string | number>({
   ...
   * @summary Configure the API.Schema.MangaContext.Chapter cut-off for API.Schema.MangaContext.Manga
   ...
   * @summary Move API.Schema.MangaContext.Manga to different API.Schema.MangaContext.FileLibrary
   ...
   * @summary (Un-)Marks API.Schema.MangaContext.Manga as requested for Download from API.MangaConnectors.MangaConnector
  ...
  mangaConnectorDetail = (
    ...
    this.request<MangaConnector, ProblemDetails>({
  ...
  metadataFetcherSearchMangaCreate = (
    ...
    this.request<MetadataSearchResult[], ProblemDetails>({
  ...
  notificationConnectorDetail = (name: string, params: RequestParams = {}) =>
    this.request<NotificationConnector, ProblemDetails>({
   ...
   * @summary Returns the API.Schema.MangaContext.Author with AuthorId
   * @request GET:/v2/Query/Author/{AuthorId}
   */
  queryAuthorDetail = (authorId: string, params: RequestParams = {}) =>
    this.request<Author, ProblemDetails>({
   ...
   * @tags Search
   * @name SearchDetail
   * @summary Initiate a search for a API.Schema.MangaContext.Manga on API.MangaConnectors.MangaConnector with searchTerm
   ...
   * @summary Returns API.Schema.MangaContext.Manga from the API.MangaConnectors.MangaConnector associated with url
  ...
  workerDetail = (workerId: string, params: RequestParams = {}) =>
    this.request<BaseWorker, ProblemDetails>({
